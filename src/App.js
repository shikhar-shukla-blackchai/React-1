...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-260823fa-3eb4-4776-815b-b8c374c00312",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-12-05 22:59:00",
        opened: true,
      },
      badges: {
        imageBadges: [
...
const Header = () => (
  <div className="header flex justify-between border ">
    <div className="logo-container">
      <img
        className="logo w-40"
        src="https://img.freepik.com/concept_306040-856.jpg?"
      />
    </div>
...
const Body = () => (
  <div className="body">
    <div className="search p-4">Secarch</div>
